...
pub const PROFILE_CONNECT_TIMEOUT: Duration = Duration::from_secs(15);
pub const PROFILE_REQUEST_TIMEOUT: Duration = Duration::from_secs(30);
pub const PROFILE_TOTAL_TIMEOUT: Duration = Duration::from_secs(120);
...
pub const IPC_PROFILE_ADD_TIMEOUT: Duration = Duration::from_secs(180);
